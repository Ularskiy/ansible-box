...
### Создание нового тома на новом устройстве
```yaml
disks:
  - operation_type: create
    device: /dev/sdb
    ...
    lvs_to_create:
      - name: data_lv
        ...
        selinux_context: default_t
```
### Расширение существующих разделов и томов
```yaml
disks:
  - operation_type: stretch
    disk_device: /dev/sda
...
### Увеличение размера одного логического тома
```yaml
disks:
